*&---------------------------------------------------------------------*
*& Include          ZR_RELATORIO_EXCEL_G_TOP
*&---------------------------------------------------------------------*
TABLES: ztb_c100_g, ztb_c170_g.

DATA: go_salv_table TYPE REF TO cl_salv_table. "classe da criação do ALV

DATA: gt_header TYPE TABLE OF ztb_c100_g,
      gt_itens  TYPE TABLE OF ztb_c170_g,
...
SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME TITLE TEXT-004. "RELATÓRIO
  PARAMETERS: p_res   RADIOBUTTON GROUP g1 DEFAULT 'X',
              p_compl RADIOBUTTON GROUP g1.
SELECTION-SCREEN END OF BLOCK b1.

SELECTION-SCREEN BEGIN OF BLOCK b2 WITH FRAME TITLE TEXT-001. "FILTROS
...
SELECTION-SCREEN BEGIN OF BLOCK b3 WITH FRAME TITLE TEXT-002.
  SELECT-OPTIONS: s_numdoc FOR ztb_c100_g-num_doc,
                  s_data FOR ztb_c100_g-dt_doc,
                  s_parc FOR ztb_c100_g-cod_part,
                  s_mdoc FOR ztb_c100_g-cod_mod,
                  s_sit  FOR ztb_c100_g-cod_sit.
SELECTION-SCREEN END OF BLOCK b3.

SELECTION-SCREEN BEGIN OF BLOCK b4 WITH FRAME TITLE TEXT-003.
  SELECT-OPTIONS: s_cfop FOR ztb_c170_g-cfop,
                  s_numit FOR ztb_c170_g-num_item,
                  s_cstic FOR ztb_c170_g-cst_icms.
